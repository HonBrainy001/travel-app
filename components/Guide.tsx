...
const Guide = () => {
  return (
    <section className='flexCenter flex-col'>
      ...
      height={50}
      />
      <p className='regular-18 -mt-1 mb-3 text-green-500'>
        WE ARE HERE FOR YOU
      </p>
      <div className='flex flex-wrap justify-between gap-5
      lg:gap-10 '>
      <h2 className='bold-40 lg:bold-64 xl:max-w-[390px]'>Guide You to Easy Path</h2>
      <p className='regular-16 text-gray-500 xl:max-w-[520px]'>Only with the hilink application you will no longer get lost and get lost again, because we already support offline 
        maps when there is no internet connection in the field.
        Invite your friends, relatives and friends to have fun in
        the wilderness through the valley and reach the top of the mountain</p>
        </div>
      </div>
      ...
      width={1440}
      height={580}
      className='w-full object-cover object-centre 
      2xl:rounded-5xl rounded-3xl overflow-hidden'
      />
