...
const CampSite = ({backgroundImage, title, subtitle, peopleJoined}
  :CampProps) => {
return (
  <div className="h-full w-full min-w-[1100px] bg-cover bg-no-repeat lg:rounded-r-5xl 2xl:rounded-5xl rounded-3xl overflow-hidden" 
    style={{
    ...
    relative flex flex-col py-10 lg:mb-10 lg:py-20 xl:mb-20'>
      ...
      <div className="flexEnd mt-10 px-6 lg:-mt-60 lg:mr-6">
        <div className="bg-green-500 p-8 lg:max-w-[500px]
          ...
          overflow-hidden rounded-3xl lg:h-[200px] xl:h-[330px]">
